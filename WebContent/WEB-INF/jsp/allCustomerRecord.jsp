...
<c:forEach items="${kzlist}" var="kz">
  ...
  <form name="searchForm" method="post" action="/allRecord.do">
<input type="hidden" name="page" id="page"/>
<table>
<tr>
<td>
<input type="text" name="true_name" id="true_name" placeholder="客户姓名" value="${svo.true_name}" />
<input type="text" name="user_idCardNumber" id="user_idCardNumber" placeholder="身份证号" value="${svo.user_idCardNumber}" />
<input type="text" name="tel_number" id="tel_number" placeholder="客户电话" value="${svo.tel_number}" />
...
<table class="table table-striped table-bordered" >
    ...
    <c:forEach items="${crlist}" var="kh">
    	<tr>
	        ...
	        <td>${kh.remarks }</td>
	        <td><a href="recordDetail.do?order_number=${kh.order_number }" class="btn btn-sm">详情</a></td>
