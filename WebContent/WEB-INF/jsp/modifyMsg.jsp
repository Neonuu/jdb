...
<script type="text/javascript">
  ...
  <hr/>
		...
		<div id="div1">
					...
					<form action="update.do?tid=${list.tid}" method="post">
					<input type="hidden" value="" id="tid" name="tid" />
						<table cellpadding="12" cellspacing="0" border="0"
							...
							<tr>
								...
								<td valign="middle" align="left">
									<textarea style="width:400px;height:80px;"class="inputgri" 
									name="sms_msg" >
									${list.sms_msg}
									</textarea>
								</td>
						...
						&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
							<input type="submit" class="button" style="width:80px;height:35px;"
							value="提交" />
