...
function getOrderId(orderId){
   if(confirm("订单状态即将改为成功批款，是否确定？")){
 	 $.ajax({
 		 url:"okOrderTwoIndex.do",
 		 data:{"id":orderId},
 		 type:"post",
 		 dataType:"json",
 		 success:function(data){
 			 if(data.err){
 				...
 				layer.msg("提交成功");
 				setTimeout(function(){
 					window.location.href="toOrderTwoIndex.do"; 
				},1000);	 
 			 }
 		 }
 	 });
   ...
   <div class="templatemo-content-wrapper">
        <div class="faq-query">
          <div class="item">
			     ...
			     <input id="date1" class="Wdate" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" placeholder="材料补齐时间" style="width:180px;"/>
				 &nbsp;&nbsp;&nbsp;&nbsp;至&nbsp;&nbsp;&nbsp;&nbsp;
				 <input id="date2" class="Wdate" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'}) "  placeholder="材料补齐订单时间" style="width:180px;"/>
			     <br/><br/>
			      &nbsp;&nbsp;
               ...
               <table border='1px' id="table1" class="table table-striped table-bordered">
				    <thead>
			           <tr>
				           ...
				           <td style="width:85px;">材料补齐时间</td><td style="width:85px;">操作者</td><td style="width:160px;">操作</td>
			           </tr>
		            </thead>
