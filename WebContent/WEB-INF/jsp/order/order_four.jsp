      ...
      success:function(data){
        ...
        for(var i=0;i<data.list.length;i++){
          str+="<tr><td>"+data.list[i].name+"</td><td>"+data.list[i].order_number+"</td><td>"+
                ...
                data.list[i].ID+")'  class='btn btn-sm'>返佣</a>&nbsp;<a href='javascript:chaKanXiangQing("+
	...
	$.ajax({
		 ...
		 success:function(data){
			...
			layer.prompt({
			    ...
			    layer.confirm('即将给用户返佣'+(money*bili/100).toFixed(2)+'元', {
			    btn: ['确定','取消'] //按钮
			}, function(){
				 $.ajax({
			 		 url:"okOrderFourIndex.do",
			 		 ...
			 		 success:function(data){
			 			 if(data.err){
			 				...
			 				layer.msg("提交成功");
			 				setTimeout(function(){
			 					window.location.href="toOrderFourIndex.do"; 
			 				},1000);
...
<body>
   <div style="text-align: left;" >
    ...
    <input type="hidden" id="bili" value="${bili}"/>
   <div class="templatemo-content-wrapper">
        <div class="faq-query">
          <div class="item">
			     ...
			     <input id="date1" class="Wdate" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" placeholder="放款时间" style="width:180px;"/>
				 &nbsp;&nbsp;&nbsp;&nbsp;至&nbsp;&nbsp;&nbsp;&nbsp;
				 <input id="date2" class="Wdate" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'}) "  placeholder="放款时间" style="width:180px;"/>
			     <br/><br/>
			      &nbsp;&nbsp;
               ...
               <table border='1px' id="table1" class="table table-striped table-bordered">
				    <thead>
			           <tr>
				           ...
				           <td style="width:115px;">放款时间</td><td style="width:85px;">操作者</td><td style="width:160px;">操作</td>
			           </tr>
		            </thead>
