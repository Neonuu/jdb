...
<form name="searchForm" method="post" action="/wodekehu.do?user_id=${svo.user_id}">
<input type="hidden" name="pagenum" id="pagenum"/>
<table>
<tr>
<td>
<input type="text" name="customer_name" id="customer_name" placeholder="客户姓名" value="${svo.customer_name}" />
<input type="text" onkeyup="value=value.replace(/[^\d]/g,'')" name="passport" id="passport" placeholder="身份证号" value="${svo.passport}" />
<input type="text" onkeyup="value=value.replace(/[^\d]/g,'')" name="phone" id="phone" placeholder="客户电话" value="${svo.phone}" />
...
<table class="table table-striped table-bordered" >
    ...
    <c:forEach items="${kehulist}" var="kh">
    	<tr>
