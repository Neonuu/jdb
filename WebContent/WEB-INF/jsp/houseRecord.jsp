...
<c:forEach items="${kzlist}" var="kz">
  ...
  <form name="searchForm" method="post" action="/houseRecord.do">
<input type="hidden" name="page" id="page"/>
<table>
<tr>
<td>
<input type="text" name="housingFCZ" id="housingFCZ" placeholder="房产证号" value="${svo.housingFCZ}" />
...
<table class="table table-striped table-bordered" >
    ...
    <c:forEach items="${crlist}" var="kh">
    	<tr>
	        ...
	        <td>${kh.housingName }</td>
	        <td>${kh.housingAddress }</td>
	        <td>${kh.housingFCZ }</td>
	        <td><a href="housePhoto.do?order_number=${kh.order_number }" class="btn btn-sm">图片</a></td>      
	    </tr>
    </c:forEach>
</table>
