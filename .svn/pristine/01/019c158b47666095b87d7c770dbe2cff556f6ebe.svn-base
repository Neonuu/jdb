...
$("#btn1").click(function(){
    ...
    $("#tbody1").html("");
    $.ajax({
      url:"dataFanYongChengGongIndex.do",
      type:"post",
   ...
   <div class="templatemo-content-wrapper">
        <div class="faq-query">
		  ...
		  <!-- <input id="product" placeholder="产品名" style="width:180px;"/>  -->   
		     ...
		     <!--  <input id="auditerName" placeholder="操作者"/> -->
			 <input id="date1" class="Wdate" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" placeholder="返佣时间" style="width:180px;"/>&nbsp;至&nbsp;
        ...
        <div class="widget-table">
            <div class="widget-content">
               <table border='1px' id="table1" class="table table-striped table-bordered">
				   <thead>
			           <tr>
				           <td>客户经理电话</td><td style="width:150px;">订单号</td><td>客户身份</td><td>产品名</td><td>客户名</td><td>身份证号</td><td>金额</td><td>操作者</td><td style="width:100px;">操作时间</td><td style="width:200px;">状态</td>
			           </tr>
		           </thead>
