      ...
      success:function(data){
        ...
        for(var i=0;i<data.list.length;i++){
          str+="<tr><td>"+data.list[i].name+"</td><td>"+data.list[i].order_number+"</td><td>"+
                data.list[i].user_identity+"</td><td>"+data.list[i].product+"</td><td>"+
        ...
        <div class="faq-query">
          <div class="item">
		    ...
		    <input id="idCardNumber" placeholder="客户身份证号"/>  &nbsp;&nbsp;
		     ...
		     <!--  <input id="auditerName" placeholder="审批人"/>  &nbsp;&nbsp;<br/><br/>-->
		     &nbsp;&nbsp;
			 <input id="date1" class="Wdate" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" placeholder="审批时间"/>&nbsp;&nbsp;&nbsp;
			 <input id="date2" class="Wdate" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'}) "  placeholder="审批时间"/>
			  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
        ...
        <div class="widget-table">
            <div class="widget-content">
               <table border='1px' id="table1" class="table table-striped table-bordered">
				   <thead>
			           <tr>
				           <td>用户名</td><td style="width:150px;">订单号</td><td>用户身份</td><td>产品名</td><td>金额</td><td>审批人</td><td style="width:100px;">审批时间</td><td style="width:200px;">状态</td>
			           </tr>
		           </thead>
