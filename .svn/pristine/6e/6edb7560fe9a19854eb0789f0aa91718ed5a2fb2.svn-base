...
<form name="searchForm" method="post" action="/moneyph.do">
...
<hr>
<h1 style="text-align: center;">成交额排行</h1>
<div id="div1">
<table class="table table-striped table-bordered">
	<tr>
	<td>排名</td><td>姓名</td><td>手机号</td><td>成交金额</td>
	</tr>
	<c:forEach items="${cjeph}" var="cje">
	<tr>
		<td>${cje.pm}</td>
		<td>${cje.user_name}</td>
		<td>${cje.user_phoneNumber }</td>
		<td>${cje.ord/10000 }万元</td>
	</tr>
	</c:forEach>
</table>
</div>  
