...
<form name="searchForm" method="post" action="/chengjiaoph.do">
	<td><input type="hidden" name="pagenum" id="pagenum"/></td>
</form>
<div align="center">
...
<hr>
<h1 style="text-align: center;">成交量排行</h1>
<div id="div1">
<table class="table table-striped table-bordered">
	<tr>
	<td>排名</td><td>姓名</td><td>手机号</td><td>成交笔数</td>
	</tr>
	<c:forEach items="${cjph}" var="cj">
	<tr>
		<td>${cj.pm}</td>
		<td>${cj.user_name}</td>
		<td>${cj.user_phoneNumber }</td>
		<td>${cj.ord }</td>
	</tr>
	</c:forEach>
</table>
