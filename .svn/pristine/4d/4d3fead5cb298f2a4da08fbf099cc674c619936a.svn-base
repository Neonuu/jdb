    ...
    $.ajax({
      ...
      success:function(data){
        ...
        for(var i=0;i<data.list.length;i++){
            ...
            data.list[i].ID+")'  class='btn btn-sm'>返佣</a></td></tr>";
        }
        $("#tbody1").append(str);
        $("#btn2").html("第"+data.page);
        $("#span").html(data.totalCount);
...
//跳转页
 ...
 $("#btn13").attr("class","btn btn-sm");
});

//点击审核时获取当前订单的id
function getOrderId(orderId){
    window.location.href="queDingFanYongIndex.do?id="+orderId;
}
</script>
</head>
   ...
   <div class="templatemo-content-wrapper">
        <div class="faq-query">
          <div class="item">
			 ...
			 <input id="date1" class="Wdate" type="text" style="width:180px;" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" placeholder="审批时间" />&nbsp;至&nbsp;
			 <input id="date2" class="Wdate" type="text" style="width:180px;" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'}) "  placeholder="审批时间"/>&nbsp;&nbsp;
        ...
        <div class="widget-table">
            <div class="widget-content" style="height: 400px;">
               <table border='1px' id="table1" class="table table-striped table-bordered">
				   <thead>
			           <tr>
				           <td>客户经理电话</td><td style="width:150px;">订单号</td><td>客户身份</td><td>产品名</td><td>客户名</td>
				           <td style="width:169px;">身份证号</td><td>电话号</td><td style="width:70px;">省份</td>
				           <td style="width:60px;">城市</td><td style="width:80px;">审批时间</td><td>审批人</td><td style="width:70px;">操作</td>
			           </tr>
		           </thead>
